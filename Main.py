        ...
        for event in GAME_EVENTS.get():
            ...
            if joystick0:
                ...
                if event.type == pygame.JOYAXISMOTION:
                    if event.dict['axis'] == 1 and event.dict['value'] < -1:
                    ...
                    if event.dict['axis'] == 0 and event.dict['value'] < -1:
                        greenTank.leftRotate = True
                        greenTank.rightRotate = False
                    if event.dict['axis'] == 0 and event.dict['value'] == 1:
                        greenTank.leftRotate = False
                        greenTank.rightRotate = True
                    elif event.dict['axis'] == 1 and event.dict['value'] < 1 and event.dict['value'] > 0:
                        greenTank.forwardDirection = False
                        greenTank.backwardDirection = False
                    elif event.dict['axis'] == 0 and event.dict['value'] < 1 and event.dict['value'] > 0:
                        greenTank.leftRotate = False
                        greenTank.rightRotate = False
                    elif event.dict['axis'] == 0 and event.dict['value'] > -1 and event.dict['value'] < 0:
                        greenTank.leftRotate = False
